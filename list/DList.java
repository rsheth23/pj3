...
public class DList extends List {
  ...
  protected DListNode newNode(Object item, DList list,
      ...
      return new DListNode(item, list, prev, next); // This makes a new DListNode passing through the args given.
  }
   ...
   **/
  public DList() {
      size = 0; // new list is empty.
      head = newNode(null, null, null, null); // new head null, doesn't have a "list"
      head.next = head; // pointers point to itself -- its circular.
      head.prev = head;
  }
  ...
  public void insertFront(Object item) {
      DListNode tempNode = newNode(item, this, head, head.next); // This is the new node we will be inserting.
      head.next.prev = tempNode; // rearrange the pointers
      head.next = tempNode;
      size++; // update size.
  }
  ...
  public void insertBack(Object item) {
      DListNode tempNode = newNode(item, this, head.prev, head); // node we will be working with.
      head.prev.next = tempNode; // rearrange pointers
      head.prev = tempNode;
      size++; // update size.
  }
