...
public class Homework6Test {
   ...
   **/
    // static SimpleBoard tempTestKey; // TESTING ONLY
   ...
   **/
    ...
    //THE FOLLOWING IS FOR TESTING: DO NOT GRADE
    /*  public static void initTable(HashTableChained table, int numBoards) {
    table.makeEmpty();
    SimpleBoard testKey; // REMOVE
    for (int i = 0; i < numBoards; i++) {
        testKey = randomBoard(); // REMOVE
        table.insert(testKey, new Integer(i)); // REMOVE
        if (i == 0) tempTestKey = testKey; // REMOVE
    }
    }*/
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Removing " + tempTestKey + ": " + table.remove(tempTestKey));
    table.testHelper();
    table.makeEmpty();
    table.testHelper();
    System.out.println("isEmpty?: " + table.isEmpty());*/
